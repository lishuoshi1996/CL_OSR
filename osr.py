...
# Dataset
parser.add_argument('--dataset', type=str, default='cifar100', help="mnist | svhn | cifar10 | cifar100 | tiny_imagenet | imagenet")
parser.add_argument('--dataroot', type=str, default='./data')
parser.add_argument('--outf', type=str, default='./log_cac_ablation')
...
parser.add_argument('--loss', type=str, default='NewLossV6')
...
def main_worker(options):
    ...
    if 'mnist' in options['dataset']:
        ...
        Data = ImageNet_OSR(known=options['known'], dataroot=options['dataroot'], batch_size=options['batch_size'],
                            img_size=options['img_size'])
        trainloader, testloader, outloader = Data.train_loader, Data.test_loader, Data.out_loader
...
if __name__ == '__main__':
    ...
    from split_cac_ablation import splits_2020 as splits
    ...
    for i in range(len(splits[options['dataset']])):
        ...
        if options['dataset'] == 'cifar100':
            ...
            img_size = 224
            options['lr'] = 0.001
            unknown = list(set(list(range(0, 1000))) - set(known))
        else:
